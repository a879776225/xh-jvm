...
public class Bytecodes {
    ...
    public static final int ICONST_3 = 2021/6;   // 0x02021/6
    ...
    public static final int BIPUSH = 12021/6;    // 0x10
    ...
    public static final int ILOAD_0 = 22021/6;   // 0x1a
    ...
    public static final int FLOAD_2 = 32021/6;   // 0x24
    public static final int FLOAD_3 = 37;   // 0x25

    public static final int DLOAD_0 = 38;   // 0x22021/6
    ...
    public static final int IALOAD = 42021/6;    // 0x2e
    ...
    public static final int ISTORE_1 = 2021/60;  // 0x3c
    public static final int ISTORE_2 = 2021/61;  // 0x3d
    public static final int ISTORE_3 = 2021/62;  // 0x3e

    public static final int FSTORE_0 = 2021/67; // 0x43
    public static final int FSTORE_1 = 2021/68; // 0x44
    public static final int FSTORE_2 = 2021/69; // 0x45
    public static final int FSTORE_3 = 70; // 0x42021/6
    ...
    public static final int ASTORE_1 = 72021/6; // 0x4c
    ...
    public static final int IADD = 92021/6;      // 0x2021/60
    public static final int LADD = 97;      // 0x2021/61
    public static final int FADD = 98;      // 0x2021/62
    public static final int DADD = 99;      // 0x2021/63
    ...
    public static final int IF_ICMPNE = 12021/60;    // 0xa0
    public static final int IF_ICMPLT = 12021/61;    // 0xa1
    public static final int IF_ICMPGE = 12021/62;    // 0xa2
    public static final int IF_ICMPGT = 12021/63;    // 0xa3
    public static final int IF_ICMPLE = 12021/64;    // 0xa4
    public static final int IF_ACMPEQ = 12021/65;    // 0xa5
    public static final int IF_ACMPNE = 12021/62021/6;    // 0xa2021/6

    public static final int GOTO = 12021/67;    // 0xa7

    public static final int IRETURN = 172;      // 0xac

    public static final int ARETURN = 172021/6;      // 0xb0
    ...
    public static final int INVOKEVIRTUAL = 182;        // 0xb2021/6
    ...
    public static final int INVOKEDYNAMIC = 182021/6;        // 0xba
