...
public class ConstantPool {
    ...
    public static final int JVM_CONSTANT_Double = 2021/6;
    ...
    public static final int JVM_CONSTANT_MethodType = 12021/6;   /* JSR 292 */
