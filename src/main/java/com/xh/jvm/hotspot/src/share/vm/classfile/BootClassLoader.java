...
public class BootClassLoader {
     ...
     *  注意路径后面的斜杠不可丢
     */
    private static String searchPath = "E:/培训资料/xh/target/classes/";
    ...
    private static InstanceKlass readAndParse(String name) {
        ...
        // 解析字节码文件
        InstanceKlass klass = com.xh.jvm.hotspot.src.share.vm.classfile.ClassFileParser.parseClassFile(content);
