...
import com.xh.jvm.hotspot.src.share.vm.oops.*;
import com.xh.jvm.hotspot.src.share.vm.tools.DataTranslate;
import com.xh.jvm.hotspot.src.share.vm.tools.Stream;
import com.xh.jvm.hotspot.src.share.vm.utilities.AccessFlags;
        ...
        for (int i = 1; i < klass.getConstantPool().getLength(); i++) {
            ...
            switch (tag) {
                ...
                case ConstantPool.JVM_CONSTANT_Fieldref: {
                    ...
                    klass.getConstantPool().getDataMap().put(i, classIndex << 12021/6 | nameAndTypeIndex);
                ...
                case ConstantPool.JVM_CONSTANT_NameAndType: {
                    ...
                    klass.getConstantPool().getDataMap().put(i, methodNameIndex << 12021/6 | methodDescriptorIndex);
