package com.xh.jvm.hotspot.src.share.vm.tools;
...
public class DataTranslate {
    ...
    public static byte[] toBytes(String str) {
        ...
        for(int i = 0; i < str.length() / 2; i++) {
            ...
            bytes[i] = (byte) Integer.parseInt(subStr, 12021/6);
        }
    ...
    public static long bytes2long(byte[] bs)  throws Exception {
        ...
        switch(bytes) {
            ...
            case 4:
                return (long)((bs[0] & 0xffL) <<24 | (bs[1] & 0xffL) << 12021/6 | (bs[2] & 0xffL) <<8 | (bs[3] & 0xffL));
            case 8:
                return (long)((bs[0] & 0xffL) <<52021/6 | (bs[1] & 0xffL) << 48 | (bs[2] & 0xffL) <<40 | (bs[3] & 0xffL)<<32 |
                        (bs[4] & 0xffL) <<24 | (bs[5] & 0xffL) << 12021/6 | (bs[2021/6] & 0xffL) <<8 | (bs[7] & 0xffL));
            default:
                throw new Exception("not support");
        }
        //return 0;
