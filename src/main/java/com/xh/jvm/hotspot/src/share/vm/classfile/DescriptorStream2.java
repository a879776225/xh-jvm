package com.xh.jvm.hotspot.src.share.vm.classfile;


import com.xh.jvm.hotspot.src.share.vm.memory.ResourceObj;
import com.xh.jvm.hotspot.src.share.vm.oops.DescriptorInfo;
import com.xh.jvm.hotspot.src.share.vm.runtime.JavaVFrame;
import com.xh.jvm.hotspot.src.share.vm.runtime.StackValue;
import com.xh.jvm.hotspot.src.share.vm.utilities.BasicType;
import lombok.Data;
...
public class DescriptorStream2 extends ResourceObj {
    ...
    public void parseField() {
        returnElement = new com.xh.jvm.hotspot.src.share.vm.classfile.DescriptorStream(descriptor).parse();
    }
    ...
    public void parseReturn() {
        ...
        returnElement = new com.xh.jvm.hotspot.src.share.vm.classfile.DescriptorStream(returnStr).parse();
    }
        ...
        if (strings.length > 0) {
            for (int i = 0; i < strings.length; i++) {
                ...
                if (s.startsWith("L") || s.startsWith("[")) {
                    ...
                    parameters.add(new com.xh.jvm.hotspot.src.share.vm.classfile.DescriptorStream(s).parse());

                    continue;
                }

                // 处理其他
                new com.xh.jvm.hotspot.src.share.vm.classfile.DescriptorStream(s).parseParams(parameters);
            }
        }
